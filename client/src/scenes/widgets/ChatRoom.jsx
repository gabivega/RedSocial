...
return (
    <WidgetWrapper>
       {/* CHAT HEADER */}
        ...
        > 
            <h3 style={{textAlign : "center", padding: "0.1rem", margin:"0.1rem"}}> ChatRoom</h3>           
            <h6 style={{ padding: "0.1rem", margin:"0.1rem"}}>Online Users: {connectedUsers} </h6>           
            {/* <Box>
              {
       ...
       sx={{padding:  "0 0 2rem"}}
            ...
            return (
            <Box
                sx={{maxWidth: "200px", wordWrap : "break-word", marginBottom: "0.5rem" }}            
                key={i}
                >{message.from === usuario ? 
                <h4 style={{color:palette.neutral.dark, display:"inline"}}> You </h4>
                :
                <h4 style={{color:"red", display:"inline"}}>
                {message.from} </h4> } : {message.message}
            </Box>
            ...
            <Typography
              fontStyle="italic"
             >New Messages:</Typography>
            {chatMessages.map((message, i)=> {
            return (
            <Box
                sx={{maxWidth: "200px", wordWrap : "break-word", paddingBottom: "0.2rem" }}            
                key={i}
                >{message.from === usuario ? 
                <h4 style={{color:palette.neutral.dark, display:"inline"}}> You </h4>
                :
